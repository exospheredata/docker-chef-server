...
FileUtils.cp '/chef-server-local.rb', '/var/opt/opscode/etc', verbose: true if File.exist? '/chef-server-local.rb'
...
if File.exist? '/var/opt/opscode/etc/chef-server-local.rb'
  reconfigure! 'Local settings require a reconfigure'
end
